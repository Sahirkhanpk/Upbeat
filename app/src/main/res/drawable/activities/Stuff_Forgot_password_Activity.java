...
public class Stuff_Forgot_password_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stuff__forgot_password_);
        ButterKnife.bind(this);

        context = Stuff_Forgot_password_Activity.this;
        activity = Stuff_Forgot_password_Activity.this;
...
//        }
        ...
        tv_number.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start,
                 ...
                 if(tv_number.getText().length()==11)
              //  if(android.util.Patterns.EMAIL_ADDRESS.matcher(tv_number.getText()).matches())
    ...
    private void getForgotPassword() {
        ...
        map.put("phone_number", tv_number.getText().toString());
      //  GlobalData.email=et_email.getText().toString();
        ...
        Call<forgot_password_response> call = apiInterface.ResetPaswword(map);
        call.enqueue(new Callback<forgot_password_response >() {
            ...
            public void onResponse(@NonNull Call<forgot_password_response > call, @NonNull Response<forgot_password_response > response) {
                ...
                if (response.isSuccessful()) {
                    Toast.makeText(Stuff_Forgot_password_Activity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
               ...
               /*     tv_text.setText("Check your email");
                 ...
                 *//*   TextView text = (TextView) layout.findViewById(R.id.text);
                    ...
                    try {
                        ...
                        Toast.makeText(Stuff_Forgot_password_Activity.this, jObjError.optString("message"), Toast.LENGTH_LONG).show();



                    } catch (IOException | JSONException e) {
                        // handle failure to read error
                        Toast.makeText(Stuff_Forgot_password_Activity.this, e.toString(), Toast.LENGTH_SHORT).show();
                    }
                }
            }
            ...
            public void onFailure(@NonNull Call<forgot_password_response > call, @NonNull Throwable t) {
                customDialog.cancel();
                Toast.makeText(Stuff_Forgot_password_Activity.this, R.string.something_went_wrong, Toast.LENGTH_SHORT).show();
            }
        });
