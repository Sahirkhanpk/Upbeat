...
public class all_categries_adapter extends RecyclerView.Adapter<adapters.all_categries_adapter.ViewHolder>{

    Context context;
    private List<Categories_Datum> list = new ArrayList<>();
    private LayoutInflater inflater;
    adapters.all_categries_adapter.ProductAdapterListener productAdapterListener;
int frist=0;
int checked_Position=0;
    public all_categries_adapter(Context context, List<Categories_Datum> list) {
    ...
    @Override
    public all_categries_adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v;
        switch (viewType) {
        ...
        /*    case VIEW_TYPE_ITEM:
                ...
                return new ViewHolder(v, false);*/
            default:
                v = inflater.inflate(R.layout.categries_item, parent, false);
                return new all_categries_adapter.ViewHolder(v, false);
        }
       /* View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.product_addons_list_item, parent, false);
        return new all_categries_adapter.ViewHolder(itemView,false);*/
    }
...
/*    @Override
    public void onBindHeaderViewHolder(all_categries_adapter.ViewHolder holder, final int section) {
    ...
    @Override
    public void onBindViewHolder(all_categries_adapter.ViewHolder holder, int absolutePosition) {
        ...
        holder.itemLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               checked_Position=absolutePosition;
                ...
                productAdapterListener.onProductClick(absolutePosition,list.get(absolutePosition).getSubcategories(),list.get(absolutePosition).getName());

            }
        });
        if(checked_Position==absolutePosition){
            holder.itemLayout.setCardBackgroundColor(context.getResources().getColor(R.color.colorGreen));
            holder.icon_category.setColorFilter(context.getResources().getColor(R.color.colorWhite));
            holder.category_name.setTextColor(context.getResources().getColor(R.color.colorWhite));
        }
        else
...
/*
    ...
    public void setProductAdapterListener(adapters.all_categries_adapter.ProductAdapterListener productAdapterListener) {
        this.productAdapterListener = productAdapterListener;
    }

    public interface ProductAdapterListener {
        void onProductClick(int category, List<Subcategory> list, String catName);
